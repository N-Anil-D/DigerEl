...
if(isset($_SESSION["Kullanici"])){
    ...
    if(($UrunTablosu != "") and ($UrunID != "")){
        ...
        if($UrunTablosu == "arac"){
            while($KayitlariYaz = $KayitCek->fetch_assoc()){
                ...
                $UrunAktifmi        = GeriDöndür($KayitlariYaz["Durumu"]);
            }
    ...
    ?>
<form action="UrunGuncelleF" method="post" enctype="multipart/form-data">
<table width="1065" height="100%" align="center" border="0" cellpadding="0" cellspacing="0">
    ...
    ?>
    <tr height="20">
        <td align="center" valign="middle"><input type="button" value="Ürünü Aktive Et" onClick="location.href='UrunAktiveEt/<?php echo $UrunID."/".$UrunTablosu; ?>';" class="YesiButon"></td>
    </tr>
    <?php
        }
        if($UrunTablosu == "arac"){ ?>
    <tr>
        <td width="1500">
            <table width="1065" height="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr><td colspan="4"><table width="1065">
                <tr height="50">
            ...
            if($UrunVaryantBasligi != ""){
                ...
                <tr height="50">
                    ...
                    <td width="10">:</td>
                    <td width="430"><input type="text" name="VaryantIcerigi<?php echo $AdIcinSayi; ?>" class="InputAlanlari" value="<?php echo $VaryantAdi; ?>"></td>
                    <td width="430"><input type="number" name="VaryantMiktari<?php echo $AdIcinSayi; ?>" class="InputAlanlari" value="<?php echo $VaryantAdedi; ?>"></td>
                </tr>
...
?>    
                ...
                <tr height="50">
                    <td colspan="4" align="center">&nbsp;&nbsp;&nbsp;<input type="submit" value="Ürünü Güncelle" class="YesiButon"></td>
                </tr>
            </table>
        </td>
    </tr>
        ...
        <td width="1500">
            <table width="1065" height="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Başlık (*)</td>
                    <td width="10">:</td>
                    <td><input type="text" name="UrunAdi" class="InputAlanlari" value="<?php echo $UrunAdi; ?>" required></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Ürün Adedi (*)</td>
                    <td width="10">:</td>
                    <td><input type="number" name="UrunAdedi" title="Sadece Sayı Giriniz" class="InputAlanlari" value="<?php echo $UrunAdedi; ?>" required></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Sehir (*)</td>
                    <td width="10">:</td>
                    <td><select name="Sehir" class="UrunEkleSelectAlani"  required><option value="<?php echo Sehir($UrunKonumu); ?>"><?php echo Sehir($UrunKonumu); ?></option><?php foreach($sehir as $key => $val){ ?><option value="<?php echo $val; ?>"><?php echo $val; ?></option><?php } ?></select></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Konumu (*)</td>
                    <td width="10">:</td>
                    <td><input type="text" name="Konumu" class="InputAlanlari" value="<?php echo KalanAdres($UrunKonumu); ?>" required></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Ürün Fiyati (*)</td>
                    <td width="10">:</td>
                    <td><input type="text" name="UrunFiyati" class="InputAlanlari" value="<?php echo FiyatGuncelle($UrunFiyati); ?>" required></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Para Birimi (*)</td>
                    <td width="10">:</td>
                    <td><select name="ParaBirimi" class="UrunEkleSelectAlani" required><option value="<?php echo $UrunParaBirimi; ?>"><?php echo $UrunParaBirimi; ?></option><option value="TL">TL</option><option value="USD">USD</option><option value="EUR">EUR</option></select></td>
                </tr>
                <tr height="50">
                    <td width="210">&nbsp;&nbsp;&nbsp;Odaları (*) :</td>
                    <td width="10">:</td>
                    <td width="850"><select name="Odasayisi" class="UrunEkleSelectAlani" style="width: 410px;" required><option value="<?php echo SalonVeOda($Urunodasayisi)[0]; ?>"><?php echo SalonVeOda($Urunodasayisi)[0]; ?></option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option></select>+
                    <select name="Salonsayisi" class="UrunEkleSelectAlani" style="width: 410px;" required><option value="<?php echo SalonVeOda($Urunodasayisi)[1]; ?>"><?php echo SalonVeOda($Urunodasayisi)[1]; ?></option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option></select></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Brutm2 (*)</td>
                    <td width="10">:</td>
                    <td><input type="number" name="Brutm2" title="Sadece Sayı Giriniz" class="InputAlanlari" value="<?php echo $UrunBrutm2; ?>" required></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Netm2 (*)</td>
                    <td width="10">:</td>
                    <td><input type="number" name="Netm2" title="Sadece Sayı Giriniz" class="InputAlanlari" value="<?php echo $UrunNetm2; ?>" required></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Isınma Tipi (*)</td>
                    <td width="10">:</td>
                    <td><select name="IsinmaTipi" class="UrunEkleSelectAlani" required><option value="<?php echo $UrunisinmaTipi; ?>"><?php echo $UrunisinmaTipi; ?></option><option value="Merkezi">Merkezi</option><option value="Kombi">Kombi</option><option value="Elektrikli">Elektrikli</option><option value="Klima">Klima</option></select></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Mobilyalı Mı  (*)</td>
                    <td width="10">:</td>
                    <td><select name="MobilyaliMi" class="UrunEkleSelectAlani" required><option value="<?php echo $UrunMobilyaliMi; ?>"><?php if($UrunMobilyaliMi=="0"){$Esya="Mobilyasız";}else{$Esya="Mobilyalı";} echo $Esya; ?></option><option value="1">Mobilyalı</option><option value="0">Mobilyasız</option></select></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Balkon (*)</td>
                    <td width="10">:</td>
                    <td><select name="Balkon" class="UrunEkleSelectAlani" required><option value="<?php echo $UrunBalkon; ?>"><?php if($UrunBalkon=="0"){$Balkon="Balkonu Yok";}else{$Balkon="Balkonu Var";} echo $Balkon; ?></option><option value="0">Balkonu Yok</option><option value="1">Balkonu Var</option></select></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Banyo Sayısı (*)</td>
                    <td width="10">:</td>
                    <td><select name="BanyoSayisi" class="UrunEkleSelectAlani" required><option value="<?php echo $UrunBanyoSayisi; ?>"><?php echo $UrunBanyoSayisi; ?></option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option></select></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Boyalı Mı</td>
                    <td width="10">:</td>
                    <td><select name="BoyaliMi" class="UrunEkleSelectAlani"><option value="<?php echo $UrunBoyaliMi; ?>"><?php if($UrunBoyaliMi=="0"){$BoyaliMi="Boyasız";}elseif($UrunBoyaliMi=="1"){$BoyaliMi="Boyalı";}else{$BoyaliMi = "";} echo $BoyaliMi; ?></option><option value="1">Boyalı</option><option value="0">Boyasız</option></select></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Bina Yaşı</td>
                    <td width="10">:</td>
                    <td><input type="number" name="BinaYasi" title="Sadece Sayı Giriniz" class="InputAlanlari" value="<?php if($UrunBinaYasi=="999"){$UrunBinaYasi = "";} echo $UrunBinaYasi; ?>"></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Kaçıncı Katta</td>
                    <td width="10">:</td>
                    <td><input type="number" name="Kat" title="Sadece Sayı Giriniz" class="InputAlanlari" value="<?php if($UrunKat=="99"){$UrunKat = "";} echo $UrunKat; ?>"></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Binadaki Toplam Kat Sayısı</td>
                    <td width="10">:</td>
                    <td><input type="number" name="BinadakiToplamKat" title="Sadece Sayı Giriniz" class="InputAlanlari" value="<?php if($UrunToplamKat=="999"){$UrunToplamKat = "";} echo $UrunToplamKat; ?>"></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;KrediyeUygunMu</td>
                    <td width="10">:</td>
                    <td><select name="KrediyeUygunMu" class="UrunEkleSelectAlani"><option value="<?php echo $UrunKrediyeUygunMu; ?>"><?php if($UrunKrediyeUygunMu=="0"){$Kredi="Krediye Uygun Değil";}elseif($UrunKrediyeUygunMu=="1"){$Kredi="Krediye Uygun";}else{$Kredi = "";} echo $Kredi; ?></option><option value="1">Krediye Uygun</option><option value="0">Krediye Uygun Değil</option></select></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Şu Anki Kullanım Durumu (*)</td>
                    <td width="10">:</td>
                    <td><select name="SuAnkiKullanimDurumu" class="UrunEkleSelectAlani" required><option value="<?php echo $UrunKullanimDurumu; ?>"><?php if($UrunKullanimDurumu=="0"){$Kullanim="Boş";}else{$Kullanim="Kullanımda";} echo $Kullanim; ?></option><option value="0">Boş</option><option value="1">Kullanımda</option></select></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Ürün Açıklaması</td>
                    <td width="10">:</td>
                    <td><textarea name="UrunAciklamasi" class="TextAlanlari"><?php echo $UrunAciklamasi; ?></textarea></td>
                </tr>
            ...
            if($UrunVaryantBasligi != ""){
                ...
                <tr height="50">
                    <td width="190">&nbsp;&nbsp;Varyant Başlığı</td>
                    <td width="10">:</td>
                    <td><select name="VaryantBasligi" class="UrunEkleSelectAlani"><option value="<?php echo $UrunVaryantBasligi; ?>"><?php echo $UrunVaryantBasligi; ?></option><option value="Renk">Renk</option></select></td>
                </tr>
                <?php 
                $VaryantCek = $DataBaseConnection->query("SELECT * FROM urunvaryantlari WHERE TabloAdi = '$UrunTablosu' AND UrunID = $UrunID");
                if($VaryantCek->num_rows){
