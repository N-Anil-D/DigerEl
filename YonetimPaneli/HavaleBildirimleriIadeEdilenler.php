...
<table width="100%" height="100%" align="center" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr height="25">
        <td align="left" bgcolor="#e67300"><a href="index.php?SKI=74" style="font-size: 17px; color: #000000; text-decoration: none;">&nbsp;&nbsp;&nbsp;BEKLEMEDEKİ ÖDEMELER</a></td>
    </tr>
    <tr height="25">
        <td align="right" bgcolor="#33cc33"><a href="index.php?SKI=79" style="font-size: 17px; color: #000000; text-decoration: none;">ONAYLANMIŞ ÖDEMELER&nbsp;&nbsp;&nbsp;</a></td>
    </tr>
    <tr>
    ...
    <tr>
        <td>
            <div class="AramaAlaniGenelDiv">
                <form action="index.php?SKI=79" method="post">
    ...
    $ToplamKayitSayisiQuery             = $DataBaseConnection->query("SELECT * FROM havalebildirimleri WHERE durum = 'İade' $AramaKosulu");
              ...
              <div class="SayfalamaAlani">
                  <div class="SayfalamaAlaniIciMetinAlani">
                      ...
                      <div class="SayfalamaAlaniIciNumaraAlani">
                          <?php 
                                if($Sayfalama > 1){
                                echo "<span class='SayfalamaLinkiPasif'><a href='index.php?SKI=79" . $SYFileMenu . "&SYF=1'> << </a></span>";
                                $sayfalamaEKSIbir = $Sayfalama - 1;
                                echo "<span class='SayfalamaLinkiPasif'><a href='index.php?SKI=79" . $SYFileMenu . "&SYF=" . $sayfalamaEKSIbir . "'> < </a></span>";
                                }
                                ...
                                for($SYFicinSayfaIndexDegeri = $Sayfalama-$SYFSagSolButonSayisi; $SYFicinSayfaIndexDegeri<=$Sayfalama+$SYFSagSolButonSayisi; $SYFicinSayfaIndexDegeri++){
                                    if(($SYFicinSayfaIndexDegeri>0) and ($SYFicinSayfaIndexDegeri<=$KacSayfaVar)){
                                        if($Sayfalama == $SYFicinSayfaIndexDegeri){
                                            ...
                                            echo "<span class='SayfalamaLinkiPasif'><a href='index.php?SKI=79" . $SYFileMenu . "&SYF=" . $SYFicinSayfaIndexDegeri . "'>" . $SYFicinSayfaIndexDegeri . "</a></span>";
                                        }
                                    }
                                }
                                ...
                                echo "<span class='SayfalamaLinkiPasif'><a href='index.php?SKI=79" . $SYFileMenu . "&SYF=" . $sayfalamaARTIbir . "'> > </a></span>";
                                echo "<span class='SayfalamaLinkiPasif'><a href='index.php?SKI=79" . $SYFileMenu . "&SYF=" . $KacSayfaVar . "'> >> </a></span>";
                                }
                          ?>
                      </div>
              </div>
    ...
    $HB_Query             = $DataBaseConnection->query("SELECT * FROM havalebildirimleri WHERE durum = 'İade' $AramaKosulu ORDER BY islemTarihi DESC LIMIT $SayfalamayaBaslanacakKayitSayisi, $SYFBasinaGosterilenKayitSayisi");
                ...
                <tr>
                    <td width="100%">
                        <table width="100%" align="left" border="0" cellpadding="0" cellspacing="0" style="color: black;">
                            ...
                            <tr bgcolor="#e6ffe6">
                                <td><b>Durum : </b><b style="color: #ff0000;"><?php echo $HB_durum; ?></b></td>
                            </tr>
                        </table>
                    </td>
<!--                    <td width="80" align="center" bgcolor="#ff8080">
    ...
    <tr>
        <td align="center">İade Edilen Havale Bildirimi bulunamadı.</td>
    </tr>
    <?php    } ?>
</table>
