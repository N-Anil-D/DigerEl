...
<table width="100%" height="100%" align="center" border="0" cellpadding="0" cellspacing="0">
    ...
    $ToplamKayitSayisiQuery             = $DataBaseConnection->query("SELECT * FROM havalebildirimleri WHERE durum = 'Onaylandı' $AramaKosulu");
    ...
    $HB_Query             = $DataBaseConnection->query("SELECT * FROM havalebildirimleri WHERE durum = 'Onaylandı' $AramaKosulu ORDER BY islemTarihi DESC LIMIT $SayfalamayaBaslanacakKayitSayisi, $SYFBasinaGosterilenKayitSayisi");
                ...
                <tr>
                    <td width="100%">
                        <table width="100%" align="left" border="0" cellpadding="0" cellspacing="0" style="color: black;">
                            ...
                            <tr bgcolor="#e6ffe6">
                                <td><b>Durum : </b><b style="color: #33cc33;"><?php echo $HB_durum; ?></b></td>
                            </tr>
                        </table>
                    </td>
    ...
    <tr>
        <td align="center">Onaylanan Havale Bildirimi bulunamadı.</td>
    </tr>
    <?php    } ?>
</table>
