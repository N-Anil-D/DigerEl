                ...
                if($ResimSilindi1 == 1){
                    ...
                    if($UrunResmiBIR->uploaded){
                        ...
                        if($UrunResmiBIR->processed){
                            ...
                            header("Location:index.php?SKI=89&eror=316");
                            exit();
                        }
                    }
                }
            ...
            if(($UrunResmiIKI["name"] != "") and ($UrunResmiIKI["type"] != "") and ($UrunResmiIKI["tmp_name"] != "") and ($UrunResmiIKI["error"] == 0) and ($UrunResmiIKI["size"] > 0)){
                ...
                if($UrunResmiIKI->uploaded){
                    ...
                    if($UrunResmiIKI->processed){
                        ...
                        header("Location:index.php?SKI=89&eror=347");
                        exit();
                    }
                }
            }
            ...
            if(($UrunResmiUC["name"] != "") and ($UrunResmiUC["type"] != "") and ($UrunResmiUC["tmp_name"] != "") and ($UrunResmiUC["error"] == 0) and ($UrunResmiUC["size"] > 0)){
                ...
                if($UrunResmiUC->uploaded){
                    ...
                    if($UrunResmiUC->processed){
                        ...
                        header("Location:index.php?SKI=89&eror=377");
                        exit();
                    } 
                }
            }
            ...
            if(($UrunResmiDORT["name"] != "") and ($UrunResmiDORT["type"] != "") and ($UrunResmiDORT["tmp_name"] != "") and ($UrunResmiDORT["error"] == 0) and ($UrunResmiDORT["size"] > 0)){
                ...
                if($UrunResmiDORT->uploaded){
                    ...
                    if($UrunResmiDORT->processed){
                        ...
                        header("Location:index.php?SKI=89&eror=407");
                        exit();
                    } 
                }
            }
                if($etkilenenKayitSayisi or ($VaryantIcerigi1 != "") or ($VaryantIcerigi2 != "") or ($VaryantIcerigi3 != "") or ($VaryantIcerigi4 != "") or ($VaryantIcerigi5 != "") or ($UrunResmiBIR->processed) or ($UrunResmiIKI->processed) or ($UrunResmiUC->processed) or ($UrunResmiDORT->processed)){
                    ...
                    header("Location:index.php?SKI=89&eror=431");/*ya resim yüklenmedi ya da sql e yüklenmedi*/
                    exit();
                }
        }else{
            header("Location:index.php?SKI=89&eror=435"); /* değerler eksik*/
            exit();
        }
    /*--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
                ...
                if($ResimSilindi1 == 1){
                    ...
                    if($UrunResmiBIR->uploaded){
                        ...
                        if($UrunResmiBIR->processed){
                            ...
                            header("Location:index.php?SKI=89&eror=735");
                            exit();
                        }
                    }
                }
            ...
            if(($UrunResmiIKI["name"] != "") and ($UrunResmiIKI["type"] != "") and ($UrunResmiIKI["tmp_name"] != "") and ($UrunResmiIKI["error"] == 0) and ($UrunResmiIKI["size"] > 0)){
                ...
                if($UrunResmiIKI->uploaded){
                    ...
                    if($UrunResmiIKI->processed){
                        ...
                        header("Location:index.php?SKI=89&eror=766");
                        exit();
                    }
                }
            }
            ...
            if(($UrunResmiUC["name"] != "") and ($UrunResmiUC["type"] != "") and ($UrunResmiUC["tmp_name"] != "") and ($UrunResmiUC["error"] == 0) and ($UrunResmiUC["size"] > 0)){
                ...
                if($UrunResmiUC->uploaded){
                    ...
                    if($UrunResmiUC->processed){
                        ...
                        header("Location:index.php?SKI=89&eror=796");
                        exit();
                    } 
                }
            }
            ...
            if(($UrunResmiDORT["name"] != "") and ($UrunResmiDORT["type"] != "") and ($UrunResmiDORT["tmp_name"] != "") and ($UrunResmiDORT["error"] == 0) and ($UrunResmiDORT["size"] > 0)){
                ...
                if($UrunResmiDORT->uploaded){
                    ...
                    if($UrunResmiDORT->processed){
                        ...
                        header("Location:index.php?SKI=89&eror=825");
                        exit();
                    } 
                }
            }
                if($etkilenenKayitSayisi or ($VaryantIcerigi1 != "") or ($VaryantIcerigi2 != "") or ($VaryantIcerigi3 != "") or ($VaryantIcerigi4 != "") or ($VaryantIcerigi5 != "") or ($UrunResmiBIR->processed) or ($UrunResmiIKI->processed) or ($UrunResmiUC->processed) or ($UrunResmiDORT->processed)){
                    ...
                    header("Location:index.php?SKI=89&eror=850");/*ya resim yüklenmedi ya da sql e yüklenmedi*/
                    exit();
                }
        }else{
            header("Location:index.php?SKI=89&eror=854"); /* veri eksik */ 
            exit();
        }
                ...
                if($ResimSilindi1 == 1){
                    ...
                    if($UrunResmiBIR->uploaded){
                        ...
                        if($UrunResmiBIR->processed){
                            ...
                            header("Location:index.php?SKI=89&eror=1099");
                            exit();
                        }
                    }
                }
            ...
            if(($UrunResmiIKI["name"] != "") and ($UrunResmiIKI["type"] != "") and ($UrunResmiIKI["tmp_name"] != "") and ($UrunResmiIKI["error"] == 0) and ($UrunResmiIKI["size"] > 0)){
                ...
                if($UrunResmiIKI->uploaded){
                    ...
                    if($UrunResmiIKI->processed){
                        ...
                        header("Location:index.php?SKI=89&eror=1132");
                        exit();
                    }
                }
            }
            ...
            if(($UrunResmiUC["name"] != "") and ($UrunResmiUC["type"] != "") and ($UrunResmiUC["tmp_name"] != "") and ($UrunResmiUC["error"] == 0) and ($UrunResmiUC["size"] > 0)){
                ...
                if($UrunResmiUC->uploaded){
                    ...
                    if($UrunResmiUC->processed){
                        ...
                        header("Location:index.php?SKI=89&eror=1164");
                        exit();
                    } 
                }
            }
            ...
            if(($UrunResmiDORT["name"] != "") and ($UrunResmiDORT["type"] != "") and ($UrunResmiDORT["tmp_name"] != "") and ($UrunResmiDORT["error"] == 0) and ($UrunResmiDORT["size"] > 0)){
                ...
                if($UrunResmiDORT->uploaded){
                    ...
                    if($UrunResmiDORT->processed){
                        ...
                        header("Location:index.php?SKI=89&eror=1196");
                        exit();
                    } 
                }
            }
                if($etkilenenKayitSayisi or ($VaryantIcerigi1 != "") or ($VaryantIcerigi2 != "") or ($VaryantIcerigi3 != "") or ($VaryantIcerigi4 != "") or ($VaryantIcerigi5 != "") or ($UrunResmiBIR->processed) or ($UrunResmiIKI->processed) or ($UrunResmiUC->processed) or ($UrunResmiDORT->processed)){
                    ...
                    header("Location:index.php?SKI=89&eror=1220");/*ya resim yüklenmedi ya da sql e yüklenmedi*/
                    exit();
                }
        }else{
            header("Location:index.php?SKI=89&eror=1224"); /* değerler eksik*/
            exit();
        }
        ...
        if(($GelenUrunAdi!="") and ($GelenUrunAdedi!="") and ($GelenKonumu!="") and ($GelenSehir!="") and ($GelenUrunFiyati!="") and ($GelenParaBirimi!="") and ($GelenMenuAdi!="") and ($GelenKimden!="") and ($GelenMarka!="") and ($GelenModel!="")){
                ...
                if($ResimSilindi1 == 1){
                    ...
                    if($UrunResmiBIR->uploaded){
                        ...
                        if($UrunResmiBIR->processed){
                            ...
                            header("Location:index.php?SKI=89&eror=1537");
                            exit();
                        }
                    }
                }
                ...
                if($ResimSilindi2 == 1 or $UrunResmi2==""){
                    ...
                    if($UrunResmiIKI->uploaded){
                        ...
                        if($UrunResmiIKI->processed){
                            ...
                            header("Location:index.php?SKI=89&eror=1571");
                            exit();
                        }
                    }
                }
                ...
                if($ResimSilindi3 == 1 or $UrunResmi3==""){
                    ...
                    if($UrunResmiUC->uploaded){
                        ...
                        if($UrunResmiUC->processed){
                            ...
                            header("Location:index.php?SKI=89&eror=1605");
                            exit();
                        } 
                    }
                }
            ...
            if(($UrunResmiDORT["name"] != "") and ($UrunResmiDORT["type"] != "") and ($UrunResmiDORT["tmp_name"] != "") and ($UrunResmiDORT["error"] == 0) and ($UrunResmiDORT["size"] > 0)){
                ...
                if($ResimSilindi4 == 1 or $UrunResmi4==""){
                    ...
                    if($UrunResmiDORT->uploaded){
                        ...
                        if($UrunResmiDORT->processed){
                            ...
                            header("Location:index.php?SKI=89&eror=1639");
                            exit();
                        } 
                    }
                }
                ...
                if($etkilenenKayitSayisi or ($VaryantIcerigi1 != "") or ($VaryantIcerigi2 != "") or ($VaryantIcerigi3 != "") or ($VaryantIcerigi4 != "") or ($VaryantIcerigi5 != "") or ($UrunResmiBIR->processed) or ($UrunResmiIKI->processed) or ($UrunResmiUC->processed) or ($UrunResmiDORT->processed)){
                    ...
                    header("Location:index.php?SKI=89&eror=1664");/*ya resim yüklenmedi ya da sql e yüklenmedi*/
                    exit();
                }
        }else{
            header("Location:index.php?SKI=89&eror=1668"); /* değerler eksik*/
            exit();
        }
    }    
