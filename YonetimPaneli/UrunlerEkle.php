...
<table width="100%" height="100%" align="center" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr height="50">
        <td align="center" bgcolor="#b3ffb3" style="color: #9900ff; font-size: 18px; font-weight: bold;">Yeni ürün Ekle</td>
    </tr>
    <tr>
        <td align="center">
            <table width="100%" height="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td width="350">
                          <table width="350" height="46" align="center" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #0066ff;">
                              <tr>
                                  <td align="center"><input class="MenuButonlari" type="button" onclick="location.href='index.php?SKI=84&TA=Arac';" value="Arac Ekle" /></td>
                              </tr>
                          </table>
                    </td>
                    <td width="350">
                          <table width="350" height="46" align="center" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #0066ff;">
                              <tr>
                                  <td align="center"><input class="MenuButonlari" type="button" onclick="location.href='index.php?SKI=84&TA=Konut';" value="Konut Ekle" /></td>
                              </tr>
                          </table>
                    </td>
                    <td width="350">
                        <table width="350" height="46" align="center" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #0066ff;">
                              <tr>
                                  <td align="center"><input class="MenuButonlari" type="button" onclick="location.href='index.php?SKI=84&TA=Giyim';" value="Giyim Ürünü Ekle" /></td>
                              </tr>
                          </table>
                    </td>
                    <td width="350">
                          <table width="350" height="46" align="center" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #0066ff;">
                              <tr>
                                  <td align="center"><input class="MenuButonlari" type="button" onclick="location.href='index.php?SKI=84&TA=Teknoloji';" value="Teknoloji Ürünü Ekle" /></td>
                              </tr>
                          </table>
                    </td>
                </tr>
    ...
    <tr>
        <td width="1350">
              <table width="1350" height="50" align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#ff6666" style="color: white">
                  <tr>
        ...
        <td width="1500">
            <table width="100%" height="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr height="50">
                    ...
                    <td width="10">:</td>
                    <td><select name="Sehir" class="UrunEkleSelectAlani" required><?php foreach($sehir as $key => $val){ ?><option value="<?php echo $val; ?>"><?php echo $val; ?></option><?php } ?></select></td>
                </tr>
                <tr height="50">
                ...
                <tr height="50">
                    ...
                    <td width="10">:</td>
                    <td><select name="Marka" class="UrunEkleSelectAlani" required><option value="Mercedes - Benz">Mercedes - Benz</option><option value="Opel">Opel</option><option value="Volkswagen">Volkswagen</option><option value="Yamaha">Yamaha</option></select></td>
                </tr>
                <tr height="50">
                ...
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Varyant Başlığı</td>
                    <td width="10">:</td>
                    <td>
                        <table>
                            <tr>
                                <td width="250">
                                      <label for="Var0"><table width="250" height="40" align="center" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #0066ff;">
                                          <tr>
                                ...
                                <td width="250">
                                      <label for="Var2"><table width="250" height="40" align="center" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #0066ff;">
                                          <tr>
                                ...
                                <td width="250">
                                      <label for="Var3"><table width="250" height="40" align="center" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #0066ff;">
                                          <tr>
                                ...
                                <td width="250">
                                    <label for="Var4"><table width="250" height="40" align="center" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #0066ff;">
                                          <tr>
                                ...
                                <td width="250">
                                      <label for="Var5"><table width="250" height="40" align="center" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #0066ff;">
                                          <tr>
        ...
        <td width="1500">
            <table width="100%" height="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Başlık (*)</td>
                    <td width="10">:</td>
                    <td colspan="2"><input type="text" name="UrunAdi" class="InputAlanlari" required></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Ürün Adedi (*)</td>
                    <td width="10">:</td>
                    <td colspan="2"><input type="number" name="UrunAdedi" title="Sadece Sayı Giriniz" class="InputAlanlari" required></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Sehir (*)</td>
                    <td width="10">:</td>
                ...
                <tr height="50">
                    ...
                    <td width="10">:</td>
                    <td width="645"><select name="Odasayisi" class="UrunEkleSelectAlani" required><option value="">Oda Sayısı</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option></select>+</td>
                    <td width="645"><select name="Salonsayisi" class="UrunEkleSelectAlani" required><option value="">Salon Sayısı</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option></select></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Brutm2 (*)</td>
                    <td width="10">:</td>
                    <td colspan="2"><input type="number" name="Brutm2" title="Sadece Sayı Giriniz" class="InputAlanlari" required></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Netm2 (*)</td>
                    <td width="10">:</td>
                    <td colspan="2"><input type="number" name="Netm2" title="Sadece Sayı Giriniz" class="InputAlanlari" required></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Isınma Tipi (*)</td>
                    <td width="10">:</td>
                    <td colspan="2"><select name="IsinmaTipi" class="UrunEkleSelectAlani" required><option value="">Lütfen Seçiniz</option><option value="Merkezi">Merkezi</option><option value="Kombi">Kombi</option><option value="Elektrikli">Elektrikli</option><option value="Klima">Klima</option></select></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Mobilyalı Mı  (*)</td>
                    <td width="10">:</td>
                    <td colspan="2"><select name="MobilyaliMi" class="UrunEkleSelectAlani" required><option value="1">Mobilyalı</option><option value="0">Mobilyasız</option></select></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Balkon (*)</td>
                    <td width="10">:</td>
                    <td colspan="2"><select name="Balkon" class="UrunEkleSelectAlani" required><option value="0">Balkonu Yok</option><option value="1">Balkonu Var</option></select></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Banyo Sayısı (*)</td>
                    <td width="10">:</td>
                    <td colspan="2"><select name="BanyoSayisi" class="UrunEkleSelectAlani" required><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option></select></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Boyalı Mı</td>
                    <td width="10">:</td>
                    <td colspan="2"><select name="BoyaliMi" class="UrunEkleSelectAlani"><option value="9"></option><option value="1">Boyalı</option><option value="0">Boyasız</option></select></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Bina Yaşı</td>
                    <td width="10">:</td>
                    <td colspan="2"><input type="number" name="BinaYasi" title="Sadece Sayı Giriniz" class="InputAlanlari"></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Kaçıncı Katta</td>
                    <td width="10">:</td>
                    <td colspan="2"><input type="number" name="Kat" title="Sadece Sayı Giriniz" class="InputAlanlari"></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Binadaki Toplam Kat Sayısı</td>
                    <td width="10">:</td>
                    <td colspan="2"><input type="number" name="BinadakiToplamKat" title="Sadece Sayı Giriniz" class="InputAlanlari"></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;KrediyeUygunMu</td>
                    <td width="10">:</td>
                    <td colspan="2"><select name="KrediyeUygunMu" class="UrunEkleSelectAlani"><option value="9"></option><option value="1">Krediye Uygun</option><option value="0">Krediye Uygun Değil</option></select></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Şu Anki Kullanım Durumu (*)</td>
                    <td width="10">:</td>
                    <td colspan="2"><select name="SuAnkiKullanimDurumu" class="UrunEkleSelectAlani" required><option value="0">Boş</option><option value="1">Kullanımda</option></select></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Ürün Açıklaması</td>
                    <td width="10">:</td>
                    <td colspan="2"><textarea name="UrunAciklamasi" class="TextAlanlari"></textarea></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Resim 1 (*)</td>
                    <td width="10">:</td>
                    <td colspan="2"><input type="file" name="UrunResmiBIR" required></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Resim 2</td>
                    <td width="10">:</td>
                    <td colspan="2"><input type="file" name="UrunResmiIKI"></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Resim 3</td>
                    <td width="10">:</td>
                    <td colspan="2"><input type="file" name="UrunResmiUC"></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Resim 4</td>
                    <td width="10">:</td>
                    <td colspan="2"><input type="file" name="UrunResmiDORT"></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Varyant Başlığı</td>
                    <td width="10">:</td>
                ...
                <tr><td colspan="4"><table class="Var2" style="display: none;">
                        <tr height="50">
                            <td width="210">&nbsp;&nbsp;Varyant Başlığı</td>
                            <td width="10">:</td>
                            <td colspan="2"><select name="VaryantBasligi" class="UrunEkleSelectAlani"><option value=""></option><option value="Renk">Renk</option></select></td>
                        </tr>
                        <tr height="50">
                ...
                <tr><td colspan="4"><table class="Var3" style="display: none;">
                        <tr height="50">
                            <td width="190">&nbsp;&nbsp;3. Varyant</td>
                            <td width="10">:</td>
                            <td><input type="text" name="VaryantIcerigi3" class="InputAlanlari" placeholder="Varyant Adı"></td>
                ...
                <tr><td colspan="4"><table class="Var4" style="display: none;">
                        <tr height="50" class="Var4" style="display: none;">
                            <td width="190">&nbsp;&nbsp;4. Varyant</td>
                            <td width="10">:</td>
                            <td><input type="text" name="VaryantIcerigi4" class="InputAlanlari" placeholder="Varyant Adı"></td>
                ...
                <tr><td colspan="4"><table class="Var5" style="display: none;">
                        <tr height="50" class="Var5" style="display: none;">
                            <td width="190">&nbsp;&nbsp;5. Varyant</td>
                            <td width="10">:</td>
                            <td><input type="text" name="VaryantIcerigi5" class="InputAlanlari" placeholder="Varyant Adı"></td>
        ...
        <td width="1500">
            <table width="100%" height="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Marka (*)</td>
                    <td width="10">:</td>
                    <td><select name="Marka" class="UrunEkleSelectAlani" required><option value="Diğer">Diğer</option><option value="Adidas">Adidas</option><option value="Bershka">Bershka</option><option value="Coccinelle">Coccinelle</option><option value="Stradivarius">Stradivarius</option><option value="Tasarımcıdan">Tasarımcıdan</option><option value="Zara">Zara</option><option value="Diğer">Diğer</option></select></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp; Ürün Durumu (*)</td>
                    <td width="10">:</td>
                    <td><select name="Kullanilabilirlik" class="UrunEkleSelectAlani" required><option></option><option value="5">Etiketi Üzerinde (Hiç Kullanılmamış)</option><option value="4">Hasarsız / Az Kullanılmış</option><option value="3">Hasarsız / Kullanılmış</option><option value="2">Kullanılmış</option></select></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Beden</td>
                    <td width="10">:</td>
                    <td><input type="text" name="Beden" class="InputAlanlari"></td>
                </tr>

                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Renk (*)</td>
                    <td width="10">:</td>
                    <td><input type="text" name="Renk" class="InputAlanlari" required></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Desen</td>
                    <td width="10">:</td>
                    <td><input type="text" name="Desen" class="InputAlanlari"></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Türü (*)</td>
                    <td width="10">:</td>
                    <td colspan="2"><select name="MenuAdi" class="UrunEkleSelectAlani" required><option value="">Türünü Seçiniz</option><option value="Elbise">Elbise</option><option value="Şort">Şort</option><option value="Takı">Takı</option><option value="Yelek">Yelek</option></select></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Ürün Fiyati (*)</td>
                    <td width="10">:</td>
                ...
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;KargoUcreti</td>
                    <td width="10">:</td>
                    <td><input type="number" name="KargoUcreti" title="Sadece Sayı Giriniz" class="InputAlanlari"></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Ürün Açıklaması</td>
                    <td width="10">:</td>
        ...
        <td width="1500">
            <table width="100%" height="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Sehir (*)</td>
                    <td width="10">:</td>
                    <td colspan="2"><select name="Sehir" class="UrunEkleSelectAlani" required><?php foreach($sehir as $key => $val){ ?><option value="<?php echo $val; ?>"><?php echo $val; ?></option><?php } ?></select></td>
                </tr>
                <tr height="50">
                    <td width="200">&nbsp;&nbsp;&nbsp;Konumu (*)</td>
                    <td width="10">:</td>
