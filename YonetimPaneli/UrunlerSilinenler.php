...
<table width="100%" height="100%" align="center" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr height="25">
        <td align="right" bgcolor="#000000"><a href="index.php?SKI=84" style="color: #00ff00; text-decoration: none;">+ Yeni Ürün Ekle&nbsp;&nbsp;&nbsp;</a></td>
    </tr>
    <tr height="25">
        <td align="left" bgcolor="#000000"><a href="index.php?SKI=83" style="color: #00ff00; text-decoration: none; font-weight: bold;">Ürünler&nbsp;&nbsp;&nbsp;</a></td>
    </tr>
    <tr height="5">
    ...
    $AracQ          = $DataBaseConnection->query("SELECT * FROM arac WHERE Durumu = 0 $AramaKosulu ORDER BY id DESC");
    $ToplamArac     = $AracQ->num_rows;
    
    $KonutQ         = $DataBaseConnection->query("SELECT * FROM konut WHERE Durumu = 0 $AramaKosulu ORDER BY id DESC");
    $ToplamKonut    = $KonutQ->num_rows;
    
    $GiyimQ         = $DataBaseConnection->query("SELECT * FROM giyim WHERE Durumu = 0 $AramaKosulu ORDER BY id DESC");
    $ToplamGiyim    = $GiyimQ->num_rows;
    
    $TeknolojiQ     = $DataBaseConnection->query("SELECT * FROM teknoloji WHERE Durumu = 0 $AramaKosulu ORDER BY id DESC");
    ...
    $AracQ              = $DataBaseConnection->query("SELECT * FROM arac WHERE Durumu = 0 $AramaKosulu ORDER BY id DESC LIMIT $SayfalamayaBaslanacakKayitSayisi, $SYFBasinaGosterilenKayitSayisi");
            ...
            <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                <tr height="50">
                    ...
                    <td width="80" align="center" bgcolor="#ffb380">
                        <a href="index.php?SKI=94&TA=arac&UrunID=<?php echo $AracId; ?>" style="text-decoration:none; color:#000000;">
    ...
    $KonutQ              = $DataBaseConnection->query("SELECT * FROM konut WHERE Durumu = 0 $AramaKosulu ORDER BY id DESC LIMIT $SayfalamayaBaslanacakKayitSayisi, $SYFBasinaGosterilenKayitSayisi");
        ...
        <td align="center">
            <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                <tr height="50">
                    ...
                    <td width="80" align="center" bgcolor="#ffb380">
                        <a href="index.php?SKI=94&TA=konut&UrunID=<?php echo $KonutId; ?>" style="text-decoration:none; color:#000000;">
                          <table width="80" height="147" align="center" border="0" cellpadding="0" cellspacing="0">
                              <tr height="60">
                                  <td width="80" height="60" align="center" style="font-size: 14px;"><b>AKTİVE ET</b></td>
                              </tr>
    ...
    $GiyimQ              = $DataBaseConnection->query("SELECT * FROM giyim WHERE Durumu = 0 $AramaKosulu ORDER BY id DESC LIMIT $SayfalamayaBaslanacakKayitSayisi, $SYFBasinaGosterilenKayitSayisi");
        ...
        <td align="center">
            <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                <tr height="50">
                    ...
                    <td width="80" align="center" bgcolor="#ffb380">
                        <a href="index.php?SKI=94&TA=giyim&UrunID=<?php echo $GiyimId; ?>" style="text-decoration:none; color:#000000;">
                          <table width="80" height="147" align="center" border="0" cellpadding="0" cellspacing="0">
                              <tr height="60">
                                  <td width="80" height="60" align="center" style="font-size: 14px;"><b>AKTİVE ET</b></td>
                              </tr>
    ...
    $TeknolojiQ              = $DataBaseConnection->query("SELECT * FROM teknoloji WHERE Durumu = 0 $AramaKosulu ORDER BY id DESC LIMIT $SayfalamayaBaslanacakKayitSayisi, $SYFBasinaGosterilenKayitSayisi");
        ...
        <td align="center">
            <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                <tr height="50">
                    ...
                    <td width="80" align="center" bgcolor="#ffb380">
                        <a href="index.php?SKI=94&TA=teknoloji&UrunID=<?php echo $TeknolojiId; ?>" style="text-decoration:none; color:#000000;">
                          <table width="80" height="147" align="center" border="0" cellpadding="0" cellspacing="0">
                              <tr height="60">
                                  <td width="80" height="60" align="center" style="font-size: 14px;"><b>AKTİVE ET</b></td>
                              </tr>
