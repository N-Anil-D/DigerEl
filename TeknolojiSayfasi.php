...
$ToplamKayitSayisiQuery             = $DataBaseConnection->query("SELECT * FROM teknoloji WHERE Durumu = 1 $MenuKosulu $AramaKosulu");
$KacTaneTUVar                     = $ToplamKayitSayisiQuery->num_rows;
    
$SayfalamayaBaslanacakKayitSayisi   = ($Sayfalama*$SYFBasinaGosterilenKayitSayisi) - $SYFBasinaGosterilenKayitSayisi;
$KacSayfaVar                        = ceil($KacTaneTUVar/$SYFBasinaGosterilenKayitSayisi);


$UrunSayisiBulmaQ        = $DataBaseConnection->query("SELECT * FROM teknoloji WHERE Durumu = 1");
...
<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
  <tr height="100">
          ...
          <tr>
              <td>
                  <table width="250" align="center" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                          <td>
                              &nbsp;&nbsp;<a href="index.php?SK=81" style="text-decoration: none;<?php if($GelenMenuID == ""){ ?> color: #FF7300; <?php }else{ ?>color: #9932CC;<?php } ?> font-weight: bold;">Tüm Menüler (<?php echo $KacTanesiOnline ?>)</a>
                          </td>
                      </tr>
                      <?php 
	function MenuYaz($MenuUstIdDegeri=0, $BoslukDegeri=0){
		...
		$MenuSorgusu			=	$DataBaseConnection->query("SELECT * FROM menuler WHERE TabloAdi = 'teknoloji' AND ustID = $MenuUstIdDegeri ORDER BY ustID");
		...
		if($MenuSorugusuSayi>0){
			while($MenuAdlari = $MenuSorgusu->fetch_assoc()){
				...
				echo '<td><div><a href="index.php?SK=81&MenuID=' . $MenuAdlari["MenuAdi"] . '" style="text-decoration: none;' . $renk . 'font-weight: bold;">' . str_repeat("&nbsp;", $BoslukDegeri). $MenuMenuAdi . ' (' . $UrunSayisi . ')</a></div>';
                    }
          ...
          <table width="795" align="center" border="0" cellpadding="0" cellspacing="0">
              <tr>
                  <td>
                      <div class="AramaAlaniGenelDiv">
                          <form action="index.php?SK=81" method="post">
                              <?php if($GelenMenuID!=""){?>
                              ...
                              <div class="AramaAlaniYaziDiv"><input type="text" name="AramadaArananKelime" class="AramaAlaniYAZI" placeholder="Ürün Adı"></div>
                          </form>
                      </div>
                  </td>
              </tr>
              ...
              <tr>
                  <td>
                    <table width="795" align="center" border="0" cellpadding="0" cellspacing="0">
                        <?php
                    $TeknolojiSayfasiQ             = $DataBaseConnection->query("SELECT * FROM teknoloji WHERE Durumu = 1 $MenuKosulu $AramaKosulu ORDER BY id DESC LIMIT $SayfalamayaBaslanacakKayitSayisi, $SYFBasinaGosterilenKayitSayisi");
                    $OnlineKayitlar                = $TeknolojiSayfasiQ->num_rows;

                    $dongusayisi=1;
                    $StunAdetSayisi=4;

                    while($tumkayitlariyaz = $TeknolojiSayfasiQ->fetch_assoc()){
                    ...
                    <td width="191">
                        <table width="191" align="center" border="0" cellpadding="0" cellspacing="0" style=" border-bottom: dashed 1px #C500BE; margin-bottom: 10px;">
                            <tr>
                                <td valign="top" align="center"><a href="index.php?SK=83&TA=teknoloji&UID=<?php echo GeriDöndür($tumkayitlariyaz["id"]); ?>"><img src="<?php echo GeriDöndür($tumkayitlariyaz["UrunResmiBIR"]); ?>" width="191" height="247"></a></td>
                            </tr>
                            <tr height="30">
                                <td width="191" align="center" style="font-size: 12px;"><a href="index.php?SK=83&TA=teknoloji&UID=<?php echo GeriDöndür($tumkayitlariyaz["id"]); ?>" style="color: #C500BE; text-decoration: none;"><div style="width: 191px; max-width: 191px; height: 20px; overflow: hidden; line-height: 20px"><?php echo GeriDöndür($tumkayitlariyaz["UrunAdi"]); ?></div></a></td>
                            </tr>
                            <tr height="25">
                                <td width="191" align="center" style="font-size: 12px;"><a href="index.php?SK=83&TA=teknoloji&UID=<?php echo GeriDöndür($tumkayitlariyaz["id"]); ?>"><img src="Resimler/<?php echo $PuaninResmi ?>"></a></td>
                            </tr>

                            <tr height="25">
                                <td width="191" align="center" style="font-size: 12px;"><a href="index.php?SK=83&TA=teknoloji&UID=<?php echo GeriDöndür($tumkayitlariyaz["id"]); ?>" style="color: #9370DB; text-decoration: none;"><b><?php echo FiyatBicimlendir($UrunFiyatiHesapla); ?> TL</b></a></td>
                            </tr>
                          ...
                          <td align="center">
                              ...
                              <div class="SayfalamaAlani">
                                  <div class="SayfalamaAlaniIciMetinAlani">
                                      Toplam <?php echo $KacSayfaVar; ?> sayfada, <?php echo $KacTaneTUVar; ?> adet Kayıt var.
                                  </div>
                                      <div class="SayfalamaAlaniIciNumaraAlani">
                                          <?php 
                                                if($Sayfalama > 1){
                                                echo "<span class='SayfalamaLinkiPasif'><a href='index.php?SK=81" . $SYFileMenu . "&SYF=1'> << </a></span>";
                                                $sayfalamaEKSIbir = $Sayfalama - 1;
                                                echo "<span class='SayfalamaLinkiPasif'><a href='index.php?SK=81" . $SYFileMenu . "&SYF=" . $sayfalamaEKSIbir . "'> < </a></span>";
                                                }
                                                ...
                                                for($SYFicinSayfaIndexDegeri = $Sayfalama-$SYFSagSolButonSayisi; $SYFicinSayfaIndexDegeri<=$Sayfalama+$SYFSagSolButonSayisi; $SYFicinSayfaIndexDegeri++){
                                                    if(($SYFicinSayfaIndexDegeri>0) and ($SYFicinSayfaIndexDegeri<=$KacSayfaVar)){
                                                        if($Sayfalama == $SYFicinSayfaIndexDegeri){
                                                            ...
                                                            echo "<span class='SayfalamaLinkiPasif'><a href='index.php?SK=81" . $SYFileMenu . "&SYF=" . $SYFicinSayfaIndexDegeri . "'>" . $SYFicinSayfaIndexDegeri . "</a></span>";
                                                        }
                                                    }
                                                }
                                                ...
                                                echo "<span class='SayfalamaLinkiPasif'><a href='index.php?SK=81" . $SYFileMenu . "&SYF=" . $sayfalamaARTIbir . "'> > </a></span>";
                                                echo "<span class='SayfalamaLinkiPasif'><a href='index.php?SK=81" . $SYFileMenu . "&SYF=" . $KacSayfaVar . "'> >> </a></span>";
                                                }
                                          ?>
                                      </div>
                              </div>
