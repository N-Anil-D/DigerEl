...
if(isset($_SESSION["Kullanici"])){
    ...
    if(isset($_POST["OdemeTuruSecimi"])){
        $OdemeTuruSecimi = GuvenlikFiltresi($_POST["OdemeTuruSecimi"]);
    }else{
        $OdemeTuruSecimi = "";
    }
    if(isset($_POST["TaksitSecimiRadio"])){
        $TaksitSecimi = GuvenlikFiltresi($_POST["TaksitSecimiRadio"]);
    }else{
        $TaksitSecimi = "";
    }
...
// -------------------------------- SIPARİSLER KISMINA AKTAR  -------------------------------- SIPARİSLER KISMINA AKTAR -------------------------------- -------------------------------- SIPARİSLER KISMINA AKTAR -------------------------------- -------------------------------- SIPARİSLER KISMINA AKTAR --------------------------------
        ...
        }elseif($OdemeTuruSecimi=="KREDI KARTI"){
          if($TaksitSecimi != ""){
            $SepeteQ     = $DataBaseConnection->query("UPDATE sepet SET OdemeSecimi='$OdemeTuruSecimi', TaksitSecimi='$TaksitSecimi' WHERE UyeID = $Uyeid ");
            if($SepeteQ){
              header("Location:KrediKartiBilgiler");
              exit();
            }else{
