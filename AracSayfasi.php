...
if($_REQUEST["MenuID"]!=""){
    ...
    $MenuKosulu  = " AND Marka = '" . $GelenMenuID . "'";
...
$ToplamKayitSayisiQuery             = $DataBaseConnection->query("SELECT * FROM arac WHERE Durumu = 1 $MenuKosulu $AramaKosulu");
...
$UrunSayisiBulmaQ        = $DataBaseConnection->query("SELECT * FROM arac WHERE Durumu = 1");
...
<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
  <tr>
          ...
          <tr>
              <td>
                  <table width="250" align="center" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                          <td>
                              &nbsp;&nbsp;<a href="Araclar/1/" style="text-decoration: none;<?php if($GelenMenuID == ""){ ?> color: #FF7300; <?php }else{ ?>color: #9932CC;<?php } ?> font-weight: bold;">Tüm Menüler (<?php echo $KacTanesiOnline ?>)</a>
                          </td>
                      </tr>
                      <?php                       
	function MenuYaz($MenuUstIdDegeri=0, $BoslukDegeri=0){
		...
		$MenuSorgusu			=	$DataBaseConnection->query("SELECT * FROM menuler WHERE TabloAdi = 'arac' AND ustID = $MenuUstIdDegeri");
		...
		if($MenuSorugusuSayi>0){
			while($MenuAdlari = $MenuSorgusu->fetch_assoc()){
				...
				echo '<td><div><a href="Araclar/1/' . $MenuAdlari["MenuAdi"] . '" style="text-decoration: none;' . $renk . 'font-weight: bold;">' . str_repeat("&nbsp;", $BoslukDegeri). $MenuMenuAdi . ' (' . $UrunSayisi . ')</a></div>';
                    }
          ...
          <table width="795" align="center" border="0" cellpadding="0" cellspacing="0">
              <tr>
                  <td>
                      <div class="AramaAlaniGenelDiv">
                          <form action="Araclar/1/" method="post">
                              <?php if($GelenMenuID!=""){?>
              ...
              <tr>
                  <td>
                    ...
                    $AracSayfasiQ             = $DataBaseConnection->query("SELECT * FROM arac WHERE Durumu = 1 $MenuKosulu $AramaKosulu ORDER BY id DESC LIMIT $SayfalamayaBaslanacakKayitSayisi, $SYFBasinaGosterilenKayitSayisi");
                    ...
                    <td width="191">
                        <table width="191" align="center" border="0" cellpadding="0" cellspacing="0" style="border-bottom: dashed 1px #C500BE; margin-bottom: 10px;">
                            <tr>
                                <td valign="top" align="center"><a href="UrunDetaylari/<?php echo $UrunAdi; ?>/<?php echo "arac"; ?>/<?php echo $UrunID; ?>"><img src="<?php echo $UrunResmiBIR; ?>" width="191" height="247"></a></td>
                            </tr>
                            <tr height="30">
                                <td width="191" align="center" style="font-size: 12px;"><a href="UrunDetaylari/<?php echo $UrunAdi; ?>/<?php echo "arac"; ?>/<?php echo $UrunID; ?>" style="color: #C500BE; text-decoration: none;"><div style="width: 191px; max-width: 191px; height: 20px; overflow: hidden; line-height: 20px"><?php echo GeriDöndür($tumkayitlariyaz["UrunAdi"]); ?></div></a></td>
                            </tr>
                            <tr height="25">
                                <td width="191" align="center" style="font-size: 12px;"><a href="UrunDetaylari/<?php echo $UrunAdi; ?>/<?php echo "arac"; ?>/<?php echo $UrunID; ?>"><img src="Resimler/<?php echo $PuaninResmi ?>"></a></td>
                            </tr>

                            <tr height="25">
                                <td width="191" align="center" style="font-size: 12px;"><a href="UrunDetaylari/<?php echo $UrunAdi; ?>/<?php echo "arac"; ?>/<?php echo $UrunID; ?>" style="color: #9370DB; text-decoration: none;"><b><?php echo FiyatBicimlendir($UrunFiyatiHesapla); ?> TL</b></a></td>
                            </tr>
                              ...
                              <div class="SayfalamaAlani">
                                  <div class="SayfalamaAlaniIciMetinAlani">
                                      ...
                                      <div class="SayfalamaAlaniIciNumaraAlani">
                                          <?php 
                                                if($Sayfalama > 1){
                                                echo "<span class='SayfalamaLinkiPasif'><a href='Araclar/1" . $SYFileMenu . "'> << </a></span>";
                                                $sayfalamaEKSIbir = $Sayfalama - 1;
                                                echo "<span class='SayfalamaLinkiPasif'><a href='Araclar/" . $sayfalamaEKSIbir . $SYFileMenu . "'> < </a></span>";
                                                }
                                                ...
                                                for($SYFicinSayfaIndexDegeri = $Sayfalama-$SYFSagSolButonSayisi; $SYFicinSayfaIndexDegeri<=$Sayfalama+$SYFSagSolButonSayisi; $SYFicinSayfaIndexDegeri++){
                                                    if(($SYFicinSayfaIndexDegeri>0) and ($SYFicinSayfaIndexDegeri<=$KacSayfaVar)){
                                                        if($Sayfalama == $SYFicinSayfaIndexDegeri){
                                                            ...
                                                            echo "<span class='SayfalamaLinkiPasif'><a href='Araclar/" . $SYFicinSayfaIndexDegeri . $SYFileMenu . "'>" . $SYFicinSayfaIndexDegeri . "</a></span>";
                                                        }
                                                    }
                                                }
                                                ...
                                                echo "<span class='SayfalamaLinkiPasif'><a href='Araclar/" . $sayfalamaARTIbir . $SYFileMenu . "'> > </a></span>";
                                                echo "<span class='SayfalamaLinkiPasif'><a href='Araclar/" . $KacSayfaVar . $SYFileMenu . "'> >> </a></span>";
                                                }
                                          ?>
                                      </div>
                              </div>
